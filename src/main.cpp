...
private:
    ...
    auto createGraphicsPipeline() -> void
    {
        ...
        auto vertShaderCode = Shader::compileShader("vert_test", shaderc_glsl_vertex_shader, vertSource);
        auto fragShaderCode = Shader::compileShader("frag_test", shaderc_glsl_fragment_shader, fragSource);
    ...
    {
        VkCommandBuffer commandBuffer = beginSingleTimeCommand(bufferCommandPool);
        ...
        endSingleTimeCommand(bufferCommandPool, commandBuffer);
    }
    ...
    auto beginSingleTimeCommand(VkCommandPool commandPool) -> VkCommandBuffer
    {
        VkCommandBufferAllocateInfo allocInfo {};
        allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
        allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    ...
    auto endSingleTimeCommand(VkCommandPool commandPool, VkCommandBuffer commandBuffer) -> void
    {
